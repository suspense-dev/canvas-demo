...
import { CreateElementEventName, MouseEventName, SceneEventName } from "./event.constants";
...
export type EventName = MouseEventName | CreateElementEventName | SceneEventName;
